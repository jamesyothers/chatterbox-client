...
// create model for each message
var Message = Backbone.Model.extend({
  url: app.server,
  initialize: function(){}
});

// create a message view for each message
var MessageView = Backbone.View.extend({
  ...
  render: function() {
    var html = this.model.get('username');
    this.$el.html(html);
  }
});
...
var messsageView = new MessageView({model: 'message'});
// instantiation of message collection
var messageList = new MessageList({model: 'message'});
// fetch data from Parse
//messageList.reset([testMsg, testMsg2, testMsg3]);
// instantiation of message collection view


// document ready, display the .el property of the message collection view
$(function() {
  messageList.fetch();
  ...
  //     }
  // });
  // call collection view to build HTML
  messageListView.render();
  console.log(message);
  console.log(messageView);
  console.log(messageList);
  console.log(messageListView);
  // append collection HTML to DOM
  $('#chats').append(messageListView.$el);
});
